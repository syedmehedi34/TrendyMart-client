    ...
    <div className="border-t-2 pt-10 border-gray-200 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="flex gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1 ">
          ...
          <button className="bg-black text-white px-8 py-3 text-sm active:bg-gray-700 font-medium hover:bg-gray-800 transition-colors duration-300 rounded cursor-pointer">
            ADD TO CART
          </button>
